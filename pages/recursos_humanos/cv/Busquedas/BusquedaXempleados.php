         ...
         <script>
          ...
          $( document ).ready(function() {
           ...
           $("#form").submit(function(e) {
            ...
            {
                $("#contenedor2").load('pages/recursos_humanos/cv/Busquedas/consultaXempleado.php',data);
                
            }

              function llegadaBusquedaCargo()
              {
                  $("#contenedor2").load('pages/recursos_humanos/cv/Busquedas/consultaXempleado.php',data2);

              }

          function llegadaBusquedaUniversidad()
          {
              $("#contenedor2").load('pages/recursos_humanos/cv/Busquedas/consultaXempleado.php',data3);
...
<div id="container">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Busqueda por empleados</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
 ...
 <div id="contenedor2" class="panel-body">
        ...
        include_once ("../../../../Datos/cargarEmpleados.php");
