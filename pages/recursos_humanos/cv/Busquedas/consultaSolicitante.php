...
require_once('../../../../Datos/conexion.php');
    ...
    if($licenciatura=='-1' or $maestria=='-1' or $doctorado=='-1'){
        ...
        if($licenciatura!='-1' and ($maestria=='-1' and $doctorado=='-1')){
            ...
            . "where ID_Tipo_estudio=1 and  Nombre_titulo='$licenciatura'))and (N_identidad "
                     . "not in(Select N_identidad from empleado)))";
            ...
            $RB=mysql_query($query);
              ...
              $query = "Select * from persona where ((N_identidad in (Select N_identidad from estudios_academico "
            . "where ID_Tipo_estudio=2 and  Nombre_titulo='$maestria'))and (N_identidad "
                     . "not in(Select N_identidad from empleado)))";
            ...
            $RB=mysql_query($query);
              ...
              $query = "Select * from persona where ((N_identidad in (Select N_identidad from estudios_academico "
            . "where ID_Tipo_estudio=3 and  Nombre_titulo='$doctorado'))and (N_identidad "
                     . "not in(Select N_identidad from empleado)))";
  ...
  //Cargo
    ...
    $cargo=$_POST['cargo'];
    $query = "Select * from persona where ((N_identidad in (Select N_identidad from experiencia_laboral where "
            . "ID_Experiencia_laboral in (select ID_Experiencia_laboral from experiencia_laboral_has_cargo "
            . "inner join cargo on cargo.ID_cargo=experiencia_laboral_has_cargo.ID_cargo where Cargo='$cargo')))"
            . "and N_identidad not in(select N_identidad from empleado))";
    ...
    if(isset($_POST['clase'])){
        $clase=$_POST['clase'];
        $query = "Select * from persona where ((N_identidad in (Select N_identidad from "
                . "experiencia_academica where ID_Experiencia_academica in (select ID_Experiencia_academica "
                . "from clases_has_experiencia_academica inner join clases on "
                . "clases.ID_Clases=clases_has_experiencia_academica.ID_Clases where Clase ='$clase')))"
                . "and N_identidad not in(select N_identidad from empleado))";
